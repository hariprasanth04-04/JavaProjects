...
public class dashboardpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL ADMINISTRATION");
        ...
        jButton1.setBounds(240, 0, 100, 32);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/hotel-facade.png"))); // NOI18N
        background.setText(" ");
        getContentPane().add(background);
        background.setBounds(0, 0, 750, 680);
